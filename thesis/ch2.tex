...
\end{equation}
where $\mathcal{F}$ is a periodic function. Let's illustrate it in the case of our differential equation. We begin by rewriting the equation \xxx{eqref} as a system of two first-order differential equations written in the matrix form:
\begin{align}
